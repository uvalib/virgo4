# lib/ext/ebsco-eds/lib/ebsco/eds/search_criteria.rb
#
# Inject EBSCO::EDS::SearchCriteria extensions and replacement methods.
      ...
      case key
        ...
        when 'q', 'query'
          ...
          if value.include?('_query_:')
            ...
            queries, search_mode = parse_solr_query(value)
