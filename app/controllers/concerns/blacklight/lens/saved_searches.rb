...
# Saved searches across all Blacklight Lens types.
#
# == Implementation Notes
# Blacklight 7 no longer includes Blacklight::SavedSearches; this module
# recreates that functionality.
#
module Blacklight::Lens::SavedSearches
