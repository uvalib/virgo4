# app/models/concerns/blacklight/lens/document/schema_org.rb
#
...
module Blacklight::Lens::Document
  ...
  #
  # @see Blacklight::Document::SchemaOrg
  #
  module SchemaOrg
    ...
    def self.make_hash(lines)
      lines.to_s
        ...
        .split("\n")
        .map { |v| [v.to_sym, "#{BASE}/#{v}".freeze] if v.present? }
        .compact
        .to_h
    end
    ...
    module ModuleMethods
      ...
      # Perform a lookup of a *mapping* (created via #itemtype_mapping) based
      # on the metadata value accessed through the given metadata *field*.
      #
      # @param [Hash]   mapping
      # @param [Symbol] field
      #
